...
<template>
  ...
  <cds-modal id="approve-modal" :open="approveModal" @cds-modal-closed="approveModal = !approveModal">
    
    <cds-modal-header> <cds-modal-heading>Approve submission</cds-modal-heading> </cds-modal-header>
    
    <cds-modal-body><p>A new client number will be created and an email will be sent to the submitter</p></cds-modal-body>

    <cds-modal-footer>
      <cds-modal-footer-button kind="secondary" data-modal-close>Cancel</cds-modal-footer-button>
      <cds-modal-footer-button kind="primary" @click="submit(true)">
        <span>Approve</span>
        <Check16 slot="icon" />
  ...
  <cds-modal id="reject-modal" :open="rejectModal" @cds-modal-closed="rejectModal = !rejectModal">

    <cds-modal-header> <cds-modal-heading>Reject submission</cds-modal-heading> </cds-modal-header>
