    ...
    >
      ...
      >
        <template v-slot:pre-header>
          ...
          <ol type="1" class="bulleted-list">
            <li>
              A registered business must be in good standing with BC Registries
            </li>
            <li>
              You must be able to receive email at {{ submitterContact.email }}
            </li>
          </ol>
          <hr />
        </template>
      ...
      >
        <template v-slot:header>
          ...
          <p class="inner-text inner-text-spaced">
            If you’d like another address, for example a seed orchard or if your
            street address is different from your mailing address, select the
            ”Add another address” button below.
          </p>
        </template>
        <template v-slot="{ validateStep, active }">
          <address-wizard-step
      ...
      >
        <template v-slot:header>
          ...
          <p class="inner-text inner-text-spaced">
            Your first name, last name and email address are from your BCeID. If
            they're incorrect,
            <a href="https://bceid.ca" target="_blank">go to BCeID</a> to update
            them before submitting your form. Be sure to add your phone number,
            location and role.
          </p>
          <p class="inner-text inner-text-spaced">
            To add another contact to the account, select "Add another contact"
            button below.
          </p>
        </template>
        <template v-slot="{ validateStep, active }">
