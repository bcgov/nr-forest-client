<template>
    <div style="margin: 24px">
        ...
        <ValidationMessages fieldId='businessInformation.incorporationNumber' :validationMessages="validationMessages"
            :modelValue="formData.businessInformation.incorporationNumber" />
        <ValidationMessages fieldId='businessInformation.clientType' :validationMessages="validationMessages"
            :modelValue="formData.businessInformation.clientType" />
        <ValidationMessages fieldId='apiErrorLblId' :validationMessages="validationMessages"
            :modelValue="formData.businessInformation.clientType" />
        <!--  -->
        ...
        <CollapseCard title="Registered business" id="businessInformationId" defaultOpen>

            <RadioInputComponent :id="'businessType'" :modelValue="[
            ...
            <ValidationMessages fieldId='businessInformation.businessType' :validationMessages="validationMessages"
                :modelValue="formData.businessInformation.businessType" />

            <div v-if="formData.businessInformation.businessType == 'R'">
                <Label label="Start typing to search for your B.C. registered business" id="businessNameLabelId" />
                <data-fetcher v-model:url="autoCompleteName" :watcher="formData.businessInformation.businessName"
                    :minLength="3" :initValue="[]" #="{ content }">
                    <AutoCompleteInputComponent :id="'complete'" v-model="formData.businessInformation.businessName"
                        :contents="content" :validations="[]" />
                </data-fetcher>
            ...
            <ValidationMessages fieldId='businessInformation.businessName' :validationMessages="validationMessages"
            ...
            <span v-if="'' !== formData.businessInformation.incorporationNumber &&
                ...
                <strong>Your business is not in good standing with BC Registries. You must go to
                    <a href="https://www.bcregistry.ca/business/auth/home/decide-business" target="_blank">BC Registries
                    </a>
        ...
        <CollapseCard title="Mailing address" id="mailingAddressId" :display="displayCommonSections" defaultOpen>

            <span>
                <strong>This information is from
                    <a href="https://www.bcregistry.ca/business/auth/home/decide-business" target="_blank">BC
                        Registries</a>.
                    If it's incorrect, go to BC Registries to update it before continuing.</strong>
            </span>

            <br /><br />
            <AddressSection id="addressListId" :addresses="formData.location.addresses"
                :validationMessages="validationMessages" />

            <ValidationMessages :fieldId="'location.addresses'" :validationMessages="validationMessages"
        ...
        <b-row class="rowSpace">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <CollapseCard id="contactsId" title="Business contacts" :display="displayCommonSections" defaultOpen>

                    <br /><br />
                    <ContactSectionComponent id="contactListId" :contacts="formData.location.contacts"
                        :validationMessages="validationMessages" />

                    <ValidationMessages :fieldId="`location.contacts`" :validationMessages="validationMessages"
        ...
        <b-button class="chefsBlue" @click="submit()">
            Submit
        </b-button>
