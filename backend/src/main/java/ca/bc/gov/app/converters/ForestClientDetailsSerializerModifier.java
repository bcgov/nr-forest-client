...
/**
 * A custom ValueSerializerModifier that modifies the serializer for ForestClientInformationDto.
 * If the bean class is assignable from ForestClientInformationDto, it returns a custom serializer
