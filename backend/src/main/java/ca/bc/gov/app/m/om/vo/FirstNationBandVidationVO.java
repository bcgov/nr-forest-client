...
public class FirstNationBandVidationVO implements Serializable {
	...
	public FirstNationBandVidationVO(String clientNumber, String corpRegnNmbr, String clientName,
			String sourceClientName, String addressOne, String sourceAddressOne, String addressTwo,
			String sourceAddressTwo, String city, String sourceCity, String province, String sourceProvince,
		...
		this.addressMatch = ((addressOne != null && sourceAddressOne != null && addressOne.equalsIgnoreCase(sourceAddressOne.replace(".", "")))
				|| (addressTwo != null && sourceAddressTwo != null && addressTwo.equalsIgnoreCase(sourceAddressTwo.replace(".", ""))))
	...
	public String toString() {
		return "FirstNationBandVidationVO [clientNumber=" + clientNumber + ", corpRegnNmbr=" + corpRegnNmbr
				+ ", clientName=" + clientName + ", sourceClientName=" + sourceClientName + ", nameMatch=" + nameMatch
				+ ", addressOne=" + addressOne + ", sourceAddressOne=" + sourceAddressOne + ", addressTwo=" + addressTwo
				+ ", sourceAddressTwo=" + sourceAddressTwo + ", city=" + city + ", sourceCity=" + sourceCity
				+ ", province=" + province + ", sourceProvince=" + sourceProvince + ", postalCode=" + postalCode
