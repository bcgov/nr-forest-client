...
public class FirstNationsStepMatcher implements StepMatcher {
  ...
  /**
   * This method returns the step matcher enumeration value for first nations steps.
   *
   * @return The StepMatchEnum value representing the first nations step.
   */
  public StepMatchEnum getStepMatcher() {
    return StepMatchEnum.STEP1FIRSTNATION;
  }
