...
@DisplayName("Integrated Test | Patch Validator : Related Clients - Related Client Location")
public class RelatedClientsRelatedClientLocationPatchValidatorIntegrationTest
    extends AbstractTestContainerIntegrationTest {

  @Autowired
  private RelatedClientsRelatedClientLocationPatchValidator validator;

  public static final String PATCH_PATH = "/relatedClients/00/0/relatedClient/location";
