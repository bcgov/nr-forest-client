...
@DisplayName("Integrated Test | Patch Validator : Related Clients - Relationship Type")
public class RelatedClientsRelationshipTypePatchValidatorIntegrationTest
    extends AbstractTestContainerIntegrationTest {
  
  @Autowired
  private RelatedClientsRelationshipTypePatchValidator validator;
  ...
  private static Stream<Arguments> validationAllowed() {
    return Stream.of(
        ...
        Arguments.of(MAPPER.createObjectNode()
            ...
            .set("value", MAPPER.createObjectNode()
                .put("code", "AG")
                .put("name", "Agent")), false)
    );
  }
  
  @Test
  @DisplayName("Should fail if relationship code is blank")
