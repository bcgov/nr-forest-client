...
public class LegacyClientControllerTest {
  ...
  public void testFindClientByIncorporationNumberOrName() {
    ...
    // given
    given(legacyClientController.findClientByIncorporationOrName(IncorporationNumber,
        COMPANY_NAME)).willReturn(result);

    // when
    List<ForestClientEntity> clients =
        legacyClientController.findClientByIncorporationOrName(IncorporationNumber, COMPANY_NAME);
  ...
  public void testFindClientIndividualByNameAndDOB() {
    ...
    // given
    given(legacyClientController.findClientByNameAndBirthdate(FirstName, LastName,
        BirthDate)).willReturn(result);

    // when
    List<ForestClientEntity> clients =
        legacyClientController.findClientByNameAndBirthdate(FirstName, LastName, BirthDate);
