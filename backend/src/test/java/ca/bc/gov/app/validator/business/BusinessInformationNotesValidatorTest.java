...
@DisplayName("Unit Tests | BusinessInformationNotesValidator")
class BusinessInformationNotesValidatorTest {

  private final BusinessInformationNotesValidator validator = new BusinessInformationNotesValidator();
