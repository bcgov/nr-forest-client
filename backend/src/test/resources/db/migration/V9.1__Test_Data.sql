...
insert into nrfc.email_log (create_timestamp, email_address, email_id, email_sent_ind, email_subject, email_variables, exception_message, template_name, update_timestamp)
values
...
('2024-12-03 06:34:35.753139', 'mail@mail.ca', '914e1e8d-2849-45a9-bba3-6f638398ad4c', 'Y', '[UAT] Client number application approved', '{"business":{"name":"01-DEV, LOAD","clientNumber":"00000172","districtName":"UAT District","districtEmail":"alliance@mail.ca"},"frontend":"https://nr-forest-client-00-frontend.uat.gov.bc.ca","userName":"LOAD 01-DEV"}', NULL, 'approval', '2024-12-03 06:34:35.753139'),
('2024-12-03 06:34:35.753139', 'mail@mail.ca', 'b1602808-49f2-4eb4-b701-2fa6097b13e9', 'Y', '[UAT] HYPERION CORP requires review', '{"business":{"name":"HYPERION CORP","districtName":"UAT District"},"frontend":"https://nr-forest-client-00-frontend.uat.gov.bc.ca","userName":"JOHN WICK","submission":2}', NULL, 'revision', '2024-12-03 06:34:35.753139')  on conflict do nothing;
