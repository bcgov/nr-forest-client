  ...
  @Query("""
      WITH AUDIT_DATA AS (
          SELECT
            ...
            LAG(CLIENT_NAME) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          ...
          SELECT
            ...
            LAG(LEGAL_FIRST_NAME) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(LEGAL_MIDDLE_NAME) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(CLIENT_STATUS_CODE) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(AL.CLIENT_TYPE_CODE) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(TO_CHAR(BIRTHDATE, 'YYYY-MM-DD')) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(CLIENT_ID_TYPE_CODE) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(CLIENT_IDENTIFICATION) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          UNION ALL
            ...
            LAG(REGISTRY_COMPANY_TYPE_CODE) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP)
            ||
            LAG(CORP_REGN_NMBR) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
        FROM THE.FOR_CLI_AUDIT AL
        ...
        WHERE CLIENT_NUMBER = :clientNumber
          ...
          SELECT
            ...
            LAG(CLIENT_ACRONYM) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(WCB_FIRM_NUMBER) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(OCG_SUPPLIER_NMBR) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
          ...
          SELECT
            ...
            LAG(CLIENT_COMMENT) OVER (PARTITION BY CLIENT_NUMBER ORDER BY AL.UPDATE_TIMESTAMP) AS OLD_VALUE,
            AL.UPDATE_TIMESTAMP,
            AL.UPDATE_USERID,
            RC.DESCRIPTION AS REASON
          FROM THE.FOR_CLI_AUDIT AL
