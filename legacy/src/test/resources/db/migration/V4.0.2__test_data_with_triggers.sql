...
values ('00000158', 'C', 'OAK HERITAGE GROUP', null, null, 'ACT', null, 'BC', '0003402', 'OAKS', null, null, null, null, 'Oldest company', TIMESTAMP '2025-04-11 21:57:32.258790', 'IDIR\\JAKETD', 70, TIMESTAMP '2025-04-11 17:57:32.267103', 'IDIR\\JAKETD', 70, 1);
...
values ('00000158', '00', 'MR', null, '00461 South Center', null, null, 'CARLETON PLACE', 'ON', 'K7AB7C', 'CANADA', '4008000000', null, null, null, 'contact@oakheritagegroup.ca', 'N', null, 'Y', TIMESTAMP '2025-04-11 20:57:32.275494', 'IDIR\\JAKETD', 70, TIMESTAMP '2025-04-11 16:57:32.283246', 'IDIR\\JAKETD', 70, 1);
...
values (client_contact_seq.NEXTVAL, '00000158', '00', 'AP', 'ELLISSA MCILVORAY', '7574522379', '2605980052', '2267331172', 'elissa@oakheritagegroup.ca', TIMESTAMP '2025-04-11 19:57:32.290626', 'IDIR\\EMCILVORAY2', 70, TIMESTAMP '2025-04-11 15:57:32.297365', 'IDIR\\EMCILVORAY2', 70, 1);
UPDATE  THE.FOREST_CLIENT SET CLIENT_STATUS_CODE = 'DAC', REVISION_COUNT = 2 WHERE CLIENT_NUMBER = '00000158';
UPDATE THE.CLIENT_UPDATE_REASON SET CLIENT_UPDATE_REASON_CODE = 'BKR' WHERE CLIENT_UPDATE_REASON_CODE = 'UND';

-- Updating the client number counter
