CREATE TABLE "LEGACY"."FOREST_CLIENT"(
...
CREATE TABLE "LEGACY"."CLIENT_DOING_BUSINESS_AS"(
...
INSERT INTO LEGACY.CLIENT_DOING_BUSINESS_AS (CLIENT_DBA_ID,CLIENT_NUMBER,DOING_BUSINESS_AS_NAME,UPDATE_TIMESTAMP,UPDATE_USERID,UPDATE_ORG_UNIT,ADD_TIMESTAMP,ADD_USERID,ADD_ORG_UNIT,REVISION_COUNT) VALUES
...
CREATE TABLE "LEGACY"."CLIENT_STATUS_CODE"(
    "CLIENT_STATUS_CODE" VARCHAR2(3),
...
INSERT INTO LEGACY.CLIENT_STATUS_CODE (CLIENT_STATUS_CODE,DESCRIPTION,EFFECTIVE_DATE,EXPIRY_DATE,UPDATE_TIMESTAMP) VALUES
...
CREATE TABLE "LEGACY"."CLIENT_LOCATION"(
    "CLIENT_NUMBER" VARCHAR2(8),
...
CREATE OR REPLACE VIEW LEGACY.V_CLIENT_PUBLIC
